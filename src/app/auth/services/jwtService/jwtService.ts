...
class JwtService extends FuseUtils.EventEmitter {
    ...
    new Promise((resolve, reject) => {
      axios
        ...
        .then(
          ...
          console.log("erfe",err.response.data.message)
   ...
   */
  validatePhoneNumebr = (phone: string) =>
    new Promise((resolve, reject) => {
      axios
        .post(jwtServiceConfig.validate, {
          phone,
        })
        .then(
          (
  ...
  /**
   * Signs in with the provided id token.
   */
  signInWithIdToken = (idToken: string) =>
    new Promise((resolve, reject) => {
      axios
        .post(jwtServiceConfig.signInWithIdToken, {
          idToken,
        })
        .then(
          (
