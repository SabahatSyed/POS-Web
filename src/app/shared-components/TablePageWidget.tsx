...
function TablePageWidget(props: TablePageWidgetProps) {
    ...
    <div className="flex w-full container">
      <div className="flex flex-col sm:flex-row flex-auto sm:items-center min-w-0 p-24 md:p-32 pb-0 md:pb-0">
        <div className="flex flex-col w-fit flex-auto">
        ...
        <div className="flex items-center mt-24 sm:mt-0 sm:mx-8 space-x-12">
          <Paper
            ...
            className="flex items-center w-full sm:max-w-256   rounded-full border-1 shadow-0"
          >
          ...
          {tableConfig.showAdd ? (
            <Button
			className="inline-flex justify-center items-center min-w-max m-auto whitespace-nowrap  bg-blue-gray-600 text-white hover:bg-blue-gray-700 hover:opacity-90"
          ...
          <Button
            className={`
    mx-8 
    ${loading ? ' inline-flex justify-center items-center min-w-max m-auto  pointer-events-none opacity-70 ' : ' inline-flex justify-center items-center min-w-max m-auto'}
  `}
            variant="contained"
            color="primary"
            startIcon={
