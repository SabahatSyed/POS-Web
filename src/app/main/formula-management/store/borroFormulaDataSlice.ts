...
const storeName = 'borroformulas';
const apiEndPoint = '/api/borroFormulas';
 ...
 * The add Checklist.
 */
export const addRecord = createAppAsyncThunk(`formulaManagement/${storeName}/addRecord`, async ({payload}: {payload: BorroFormula}) => {
...
export const updateRecord = createAppAsyncThunk(`formulaManagement/${storeName}/updateRecord`, async ({payload , id}: {payload: BorroFormula , id:string}) => {
