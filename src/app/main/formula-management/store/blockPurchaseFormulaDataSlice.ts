...
const storeName = 'blockPurchaseFormulas';
const apiEndPoint = '/api/blockPurchaseFormulas';
 ...
 * The add Checklist.
 */
export const addRecord = createAppAsyncThunk(`formulaManagement/${storeName}/addRecord`, async ({payload}: {payload: BlockPurchaseFormula}) => {
...
export const updateRecord = createAppAsyncThunk(`formulaManagement/${storeName}/updateRecord`, async ({payload , id}: {payload: BlockPurchaseFormula , id:string}) => {
