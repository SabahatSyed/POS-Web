...
import { addRecord, getRecords, updateRecord } from '../store/blockPurchaseFormulaDataSlice';
...
/**
 * BlockPurchaseFormulaFormPage
 */
function BlockPurchaseFormulaFormPage() {
...
export default BlockPurchaseFormulaFormPage;