...
/**
 * The page displayed after the password reset link has been sent to the user's email.
 */
function PasswordResetLinkSentPage() {
	return (
			...
			<Paper className="min-h-full w-full rounded-0 px-16 py-32 sm:min-h-auto sm:w-auto sm:rounded-2xl sm:p-48 sm:shadow">
				<div className="mx-auto w-full max-w-320 sm:mx-0 sm:w-320">
					...
					<Typography className="mt-16">
						...
						the instructions provided in the email to reset your password.
					</Typography>
