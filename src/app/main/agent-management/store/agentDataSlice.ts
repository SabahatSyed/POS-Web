...
const storeName = 'agents';
const apiEndPoint = '/api/agents';
 ...
 * The add user.
 */
export const addRecord = createAppAsyncThunk(`agentManagement/${storeName}/addRecord`, async ({payload}: {payload: User}) => {
...
export const updateRecord = createAppAsyncThunk(`agentManagement/${storeName}/updateRecord`, async ({payload , id}: {payload: User , id:string}) => {
