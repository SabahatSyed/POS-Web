...
const storeName = 'agentInvite';
const apiEndPoint = '/api/agentInvite';
 ...
 * The add user.
 */
export const addRecord = createAppAsyncThunk(`agentManagement/${storeName}/addRecord`, async ({payload}: {payload: AgentInvite}) => {
...
export const updateRecord = createAppAsyncThunk(`agentManagement/${storeName}/updateRecord`, async ({payload , id}: {payload: AgentInvite , id:string}) => {
