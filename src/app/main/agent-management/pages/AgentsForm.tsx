...
import { addRecord, getRecords, updateRecord } from '../store/agentDataSlice';
import { Customer } from '../../general-management/types/dataTypes';
...
function AgentsFormPage() {
	...
	const [rowData, setRowData] = useState<Customer | undefined>(undefined);
			...
			<div className="grid sm:grid-cols-2 gap-16 gap-y-40 gap-x-12 lg:w-full w-full  lg:ml-10">
				...
				{/* <div className="sm:col-span-1 ">
					<Controller
						...
						control={control}
						render={({ field }) => (
							<DropdownWidget dataSource={getRolesRecords} field={field} errors={errors}></DropdownWidget>
						)}
					/>
				</div> */}
