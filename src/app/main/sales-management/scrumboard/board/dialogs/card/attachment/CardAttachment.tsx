...
function CardAttachment(props: CardAttachmentProps) {
	...
	if (item.type === 'image') {
		...
		imgSrc = '/assets/images/apps/scrumboard/pdf.png'
	}
	else if (item.type === 'word') {
		imgSrc = '/assets/images/apps/scrumboard/word.png'
	}
	...
	return (
		...
		>
			<div className="flex items-center justify-center min-w-128 w-128 h-128">
				<Paper className="overflow-hidden shadow h-112 w-112">
					<img
			...
			<div className="flex flex-auto flex-col justify-center items-start min-w-0 px-16">
				<div className="flex items-center w-full">
					<Typography className="text-16 font-semibold truncate shrink !bg-transparent !border-none !outline-none">
						<Link to={item.url} target='_blank' className='!bg-transparent !border-none !outline-none'>
				...
				>
					{format(fromUnixTime(item.time / 1000), 'Pp')}
