...
function SellerTokenPage() {
  ...
  function onSubmit() {
    ...
    const storeFrontUrl = searchParams.get("storeFrontUrl");
    const period = "";
    const subscription = "";
    ...
    jwtService
      ...
      .then((user: UserType) => {
        ...
        setTimeout(() => {
          console.log("SellerTokenPage redirect url", user.loginRedirectUrl);
          history.push(`/storefront-search?storeFrontUrl=/${storeFrontUrl}`);
        }, 100);
...
export default SellerTokenPage;
