...
import { addRecord, getRecords , updateRecord } from '../store/labelDataSlice';
...
function LabelFormPage() {
	...
	const [rowData, setRowData] = useState<Label | undefined>(undefined);
	const [loading, setLoading] = useState(false);
	const navigate = useNavigate();
	const { isValid, dirtyFields, errors, touchedFields } = formState;

	const onSubmit = async (formData: Label) => {
		try {
			setLoading(true);
		  	if (id) {
