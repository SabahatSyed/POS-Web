...
import { addRecord, getRecords , updateRecord } from '../store/checklistDataSlice';
...
function ChecklistFormPage() {
	...
	const [rowData, setRowData] = useState<Checklist | undefined>(undefined);
	const [loading, setLoading] = useState(false);
	const navigate = useNavigate();
	const { isValid, dirtyFields, errors, touchedFields } = formState;

	const onSubmit = async (formData: Checklist) => {
		try {
			setLoading(true);
		  	if (id) {
